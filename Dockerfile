...
# Browser-visible values are compiled into the Next.js bundle at build time.
# Always pass them explicitly for the target environment; do not add defaults here.
