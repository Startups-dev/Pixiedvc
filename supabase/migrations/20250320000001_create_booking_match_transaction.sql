create or replace function public.apply_booking_match(
  ...
  p_points_reserved integer,
  p_points_reserved_current integer,
  p_points_reserved_borrowed integer,
  p_borrow_membership_id uuid,
  p_expires_at timestamptz,
  p_owner_base_rate_per_point_cents integer,
  p_owner_premium_per_point_cents integer,
  p_owner_rate_per_point_cents integer,
  p_owner_total_cents integer,
