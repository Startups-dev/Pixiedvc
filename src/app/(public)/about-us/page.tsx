export default function AboutUsPage() {
  return (
    <main className="mx-auto max-w-4xl px-6 py-16 text-slate-900">
      ...
      <p className="mt-4 text-base text-slate-500">
        We focus on verified owners, transparent pricing, and hands-on support so each booking moves forward with
        confidence.
      </p>
      <p className="mt-4 text-base text-slate-500">
        Learn more about our approach and how we keep owners in control throughout the process.
      </p>
    </main>
  );
}
