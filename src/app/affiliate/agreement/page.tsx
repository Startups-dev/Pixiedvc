...
export default function AffiliateAgreementPage() {
  return (
    <main className="mx-auto max-w-4xl px-6 py-16">
      <p className={`text-xs uppercase tracking-[0.28em] ${affiliateTextMuted}`}>HannaDVC</p>
      ...
      <div className={`mt-8 space-y-5 rounded-2xl p-8 text-sm leading-7 ${affiliateCard}`}>
        <p>
          By participating in the HannaDVC Affiliate Program, you agree to promote HannaDVC accurately and in good
          faith. You may not make misleading claims about availability, pricing, or guarantees.
        </p>
        <p>
          HannaDVC reserves the right to suspend or terminate affiliate accounts that promote in ways inconsistent with
        ...
        <p>
          Commission eligibility is based on confirmed bookings tracked through official HannaDVC referral links.
