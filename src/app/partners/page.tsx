          ...
          <div className="rounded-3xl border border-[#0F2148]/10 bg-white p-6 shadow-[0_20px_60px_rgba(12,15,44,0.08)]">
            ...
            <div className="mt-4 flex flex-wrap gap-2">
              <Link
                ...
                className="inline-flex items-center rounded-full border border-[#0F2148]/15 bg-[#0F2148] px-4 py-2 text-xs font-semibold !text-white transition hover:bg-[#0B1B3A]"
              >
                Apply to Affiliate Program
              </Link>
              <Link
                href="/affiliate/login"
                className="inline-flex items-center rounded-full border border-[#0F2148]/20 px-4 py-2 text-xs font-semibold text-[#0F2148] transition hover:bg-[#0F2148]/5"
              >
