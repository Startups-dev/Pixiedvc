...
export default async function AdminGuestPromotionsPage() {
  await requireAdminUser('/admin/promotions/guests');

  const adminClient = getSupabaseAdminClient();
  const initialEnabled = adminClient
    ? await getPromotionsSetting('promotions_guest_enrollment_enabled')
