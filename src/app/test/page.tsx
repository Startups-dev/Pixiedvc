  ...
  return (
    <main className="mx-auto max-w-3xl px-6 py-16">
      <div className="rounded-3xl border border-slate-200 bg-white p-8 shadow-sm">
        ...
        <h1 className="mt-2 text-2xl font-semibold text-slate-900">HannaDVC User Test Access</h1>
        <p className="mt-3 text-sm text-slate-600">
          Private testing requires an invite link. Use the exact link provided by the HannaDVC team to start your
