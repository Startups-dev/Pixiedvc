...
const RESORTS_BY_CODE: Record<string, ResortImageSpec> = {
  ...
  RVA: { folder: "Riviera", prefix: "RR", ext: "png" },
...
const RESORTS_BY_SLUG: Record<string, ResortImageSpec> = {
  ...
  "copper-creek-villas-and-cabins": RESORTS_BY_CODE.CCV,
  "copper-creek-villas-cabins": RESORTS_BY_CODE.CCV,
  "grand-floridian-villas": RESORTS_BY_CODE.VGF,
  "old-key-west": RESORTS_BY_CODE.OKW,
  "polynesian-villas": RESORTS_BY_CODE.PVB,
  "riviera-resort": RESORTS_BY_CODE.RVA,
  ...
  "disney-s-copper-creek-villas-cabins": RESORTS_BY_CODE.CCV,
  ...
  "disney-s-riviera-resort": RESORTS_BY_CODE.RVA,
