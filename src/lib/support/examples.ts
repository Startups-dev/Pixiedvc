export const SUPPORT_EXAMPLES = [
  ...
  },
  {
    ...
    assistant:
      "Ready Stays are pre-confirmed reservations that can be booked quickly. They’re useful if you want faster checkout flow versus building a custom request from scratch.",
  },
  {
    user: "Ready Stays vs custom request?",
    assistant:
      "Ready Stays are already confirmed inventory, while custom requests are matched to your exact trip preferences. If you want speed, Ready Stays are great; if you want flexibility, custom can be better.",
  },
  {
    user: "Why do some Ready Stays expire?",
    assistant:
      "Ready Stays reflect live availability windows, so listings can expire when timing or inventory conditions change. If one expires, we can help you find close alternatives quickly.",
  },
  {
  ...
  },
  {
    ...
    assistant:
      "You move into booking package details and confirmation steps. From there, you’ll see progress updates and required actions until completion.",
  },
  {
